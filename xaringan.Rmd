...
---
## Visitors between 2013-2019

This is  the general evolution of visitors to Scotland by age. It can argue that there is not a clear tendency, each group of age had a preferred year in visit Scotland. Although from 2017 there is a general decline.Each year is different, for 2019 the data show that mostly all the age groups fall and the only two that grow significantly , 65 or older and 35-44 years old , are under the mark of their best year that was 2016.
...
.footnote[
[1] ??????????????????[????????????](https://slides.yihui.org/xaringan/zh-CN.html)
